...
@app.post("/add-new-todo", status_code=status.HTTP_201_CREATED, tags=["Todos"])
...
@app.put("/update-todo/{todo_id}", status_code=status.HTTP_204_NO_CONTENT, tags=["Todos"])
...
@app.delete("/delete_todo/{todo_id}", status_code=status.HTTP_204_NO_CONTENT, tags=["Todos"])
